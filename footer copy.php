<div id="footer" class="bg-dark pt-5">
    ...
    <div class="container-fluid border-top border-secondary">
        <div class="mt-4 pb-4 row">
            ...
            <div class="align-items-center col-lg-6 col-sm-12 col-md-12 d-flex justify-content-lg-end justify-content-center text-center text-lg-end">
                <a target="_blank" href="https://www.facebook.com/erimarc.ao" class="nav-link text-secondary fa-2x fab fa-facebook"></a>
                <a target="_blank" href="https://www.instagram.com/erimarc.ao" class="nav-link text-secondary fa-2x fab fa-instagram"></a>
                <a target="_blank" href="https://www.linkedin.com/company/erimarc-angola" class="nav-link text-secondary fa-2x fab fa-linkedin"></a>
            </div>
        </div>
    </div>

    <div class="cookeis position-fixed">
        <div class="bg-white container m-0 p-0">
            <div class="conteudo">
                <div class="col-12 p-4">
                    <p class="m-0">Usamos cookies neste site, incluindo cookies de terceiros, para que o site funcione corretamente e para analisar o tráfego, oferecer funcionalidade aprimorada, recursos de mídia social e personalizar conteúdo e anúncios.</p>
                </div>
    ...
    <div class="align-items-center d-flex justify-content-center p-2 position-fixed rounded-circle whatsappme__button">
        <a href="https://wa.me/244995736815" target="_blank" class="d-block">
            <svg width="40" height="40" viewBox="-8 -8 40 40">
...
<script src="<?php echo URL_BASE ?>assets/js/erimarc.js"></script>
</body>
