<div class="container-fluid bg-light">
    <div class="mt-5 p-5 section-light section-send-message">
        <div class="row">
            <div class="text-center flex-column align-items-center d-flex justify-content-center col-12 col-md-12 col-lg-12 col-sm-12">
                <h1 class="fw-normal display-6" style="letter-spacing: -1px;">Soluções pioneiras para proteção total de energia</h1>
                <p class="my-4 fs-5">
