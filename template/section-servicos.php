            ...
            <div class="align-items-end d-flex" style="height: 350px;background-image: url(https://dummyimage.com/240x800/ffeaaa/ffffff);background-position: center;background-size: cover;">
                <div class="text-center" style="height: fit-content;">
                    ...
                    <div class="content text-center">
                        <p class="p-4" style="font-size:10pt">Erimarc é a sua fonte confiável de UPS e equipamentos de alimentação crítica associados</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-3 col-md-6 col-sm-12 col-xs-4 services">
            <div class="align-items-end d-flex" style="height: 350px;background-image: url(https://dummyimage.com/240x800/ffeaaa/ffffff);background-position: center;background-size: cover;">
                <div class="text-center" style="height: fit-content;">
                    ...
                    <div class="content text-center">
                        <p class="p-4" style="font-size:10pt">Fornecimento de planos de manutenção abrangentes para estender a vida útil do seu equipamento e maximizar o tempo de atividade</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-3 col-md-6 col-sm-12 col-xs-4 services">
            <div class="align-items-end d-flex" style="height: 350px;background-image: url(https://dummyimage.com/240x800/ffeaaa/ffffff);background-position: center;background-size: cover;">
                <div class="text-center" style="height: fit-content;">
                    ...
                    <div class="content text-center">
                        <p class="p-4" style="font-size:10pt">Fornecemos um sistema integrado de gerenciamento e monitoramento de bateria em rede Ethernet.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-3 col-md-6 col-sm-12 col-xs-4 services">
            <div class="align-items-end d-flex" style="height: 350px;background-image: url(https://dummyimage.com/240x800/ffeaaa/ffffff);background-position: center;background-size: cover;">
                <div class="text-center" style="height: fit-content;">
                    ...
                    <div class="content text-center">
                        <p class="p-4" style="font-size:10pt">Fornecemos e instalamos baterias de todos os tipos em todos os modelos de UPS e sistemas de energia seguros.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container text-white py-5">
        <div class="row text-center">
            ...
            <div class="col-lg-4">
                ...
                <h3 class="display-3 fw-normal views-number">0</h3>
                <div class="content">
