        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="align-items-center align-items-lg-start d-flex flex-column mb-4 mb-lg-0 mb-md-3">
                    ...
                    <p class="fs-5 my-4">
                        Visite a nossa galeria de fotos com alguns dos trabalhos que já realizamos ao longo dos anos.
                    </p>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="image">
                    <img src="<?php echo URL_BASE ?>assets/img/gallery.jpg" class="img-fluid" alt="" srcset="<?php echo URL_BASE ?>assets/img/gallery.jpg" sizes="(max-width:100%) 880px">
                </div>
            </div>
        </div>
    </div>
